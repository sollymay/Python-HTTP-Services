...
def update_post():
    ...
    view_count = input('view_count: ['+post.view_count+']')
    view_count = view_count if view_count else post.view_count

    post_data = dict(title=title, content=content,
                     view_count=view_count, published=post.published_text)
    ...
    print("Successfully update {}".format(post.title))
